        ...
        <div id='explanations'>
          <div id='rules'>
            ...
            <ul className='list'>
              ...
              <li><p><span className='bold'>Plurals count</span> —  duh, if you see <span className='italic'>pigs</span> on a moto instead of <span className='italic'>a pig</span> on a moto, you get the space, and bonus, you saw a lot of pigs, aren't they cute?</p></li>
